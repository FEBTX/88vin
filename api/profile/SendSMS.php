...
$result = getOtp($Username, $CurrencyID, $ServiceID, $auth_token);
$json_data = json_decode($result, 1);
echo $result;

function getOtp($Username, $CurrencyID, $ServiceID, $auth_token) {
    $url = "https://profile.g88.vin/api/profile/SendSMS";
    $ch = curl_init();
