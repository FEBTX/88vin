!function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e(require("libs"), require("WebFont"), require("pixi-filters")) : "function" == typeof define && define.amd ? define("tlmn", ["libs", "WebFont", "pixi-filters"], e) : "object" == typeof exports ? exports.tlmn = e(require("libs"), require("WebFont"), require("pixi-filters")) : t.tlmn = e(t.libs, t.WebFont, t["pixi-filters"])
    ...
    , function(t, e, n) {
        ...
        r.prototype.InitBg = function() {
            ...
            var t = new PIXI.Text(Message.GetMessage("na3"),{
        ...
        r.prototype.BtnHitClick = function(e) {
            var n = this;
            e.selectedCards.length <= 0 ? e.ShowStatus(Message.GetMessage("ca-10020")) : (e.DisableButton(this),
        ...
        r.prototype.StartActions = function(t, e, n, i) {
            ...
            console.log("start actions", this.players),
        ...
        function r(t) {
            ...
            this.isPlaying = !1,
            this.numb = [0, 0, 0, 0],
            this.playerPos = [[-500, 86], [510, -55], [360, -270], [-485, -169]],
            this.handCardsPos = [{
                x: -360,
                y: 186,
                scale: 1.5
            ...
            this.ShowResult = function(t) {
                ...
                t) {
                    ...
                    for (e in t.GameLoop.SessionResult.ResultList) {
                        ...
                        if (5 === h.ResultFamily) {
                            var d = new AnimatedSprite(i.framesFireWork);
                            d.anchor.set(.5),
                            d.animationSpeed = .5,
                            d.play();
                            ...
                            f.position.set(0, 22),
                            u.addChild(f),
                            o.effectContainer.addChild(d, u),
                            0 <= h.WinType) {
                            ...
                            d.scale.set(.7),
                            d.position.set(o.avatar.x, o.avatar.y))
                        } else {
                            var y;
    ...
    , function(t, e, n) {
        ...
        h.prototype.RemoveEffect = function() {
            if (console.log(this.effectContainer),
