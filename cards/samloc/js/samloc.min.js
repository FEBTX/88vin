!function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e(require("libs"), require("WebFont"), require("pixi-filters")) : "function" == typeof define && define.amd ? define("samloc", ["libs", "WebFont", "pixi-filters"], e) : "object" == typeof exports ? exports.samloc = e(require("libs"), require("WebFont"), require("pixi-filters")) : t.samloc = e(t.libs, t.WebFont, t["pixi-filters"])
    ...
    , function(t, e, n) {
        ...
        r.prototype.InitHub = function(t) {
            this.hub = new a.default(locUrl + "hub",this.token,this),
        ...
        r.prototype.InitBg = function() {
            ...
            var t = new PIXI.Text(Message.GetMessage("na4"),{
        ...
        r.prototype.StartActions = function(t, e, n, i) {
            ...
            try {
                ...
                if (t === this.currentPlayer.AccountID)
                    ...
                    s = 0; s < e.length; s++) {
                        var h = e[s];
                        h === this.locActionName.DANH_BAI ? (this.EnableButton(this.btnHit),
                        0 < this.selectedCards.length ? (this.EnableButton(this.btnHit),
