webpackJsonp([4, 11], {
    ...
    601: function(e, t, n) {
        ...
        var a, i = n(0), o = (n.n(i),
        n(2)), l = n(330), r = n(738), s = n(744), c = n(746), u = n(12), p = n(666), h = n(690), b = n(10), d = n(9), m = n(4), v = n(756), f = n.n(v), g = this && this.__extends || (a = function(e, t) {
            return (a = Object.setPrototypeOf || {
                __proto__: []
            }instanceof Array && function(e, t) {
                e.__proto__ = t
        ...
        , N = Object(l.a)({
                ...
                return y(this, void 0, void 0, function() {
                    ...
                    return w(this, function(u) {
                        ...
                        case 1:
                            ...
                            this.gameConfig ? (sessionStorage.setItem("GAME_TAB", "casino"),
                            window.dispatchEvent(new Event("resize")),
                            this.setState({
                                showLoading: !0,
                                mounted: !0
                            }),
                            s = E(this.gameConfig.files),
                            this.loadJs(s, function() {
                                try {
                                    var e = o.i.getAccessToken()
                                      , t = o.i.getCurrency();
                                    window[c.gameConfig.hubName] = c.gameConfig.url,
                                    c.game = new window[c.gameConfig.name].game({
            ...
            t.prototype.componentDidUpdate = function(e) {
                if (this.game && this.game.game.isLoad) {
                    var t = this.props.match.params
                      ...
                      , a = t.type;
                    if (!n || !a)
                        return window.Config.inCardGame = !1,
                        void (this.game.delete && this.game.game.ready && this.game.delete());
                    var i = e.match.params
                      , o = i.value
                      , l = i.type;
                    o == n && l == a || (this.game.game.ready = !1,
                    this.game.join(n, a),
            ...
            t.prototype.render = function() {
                var e = this.props.match.params
                  ...
                  , b = ""
                  , d = !0;
                this.gameConfig && (u = this.gameConfig.element,
                b = this.gameConfig.gameName),
                t && n && (d = !1);
    ...
    651: function(e, t, n) {
        ...
        var a, i = n(0), o = (n.n(i),
        n(701)), l = n(702), r = n(9), s = this && this.__extends || (a = function(e, t) {
            return (a = Object.setPrototypeOf || {
                __proto__: []
            }instanceof Array && function(e, t) {
                e.__proto__ = t
    ...
    666: function(e, t, n) {
        ...
        var a, i = n(0), o = (n.n(i),
        n(667)), l = (n.n(o),
        n(4)), r = n(9), s = n(12), c = n(622), u = this && this.__extends || (a = function(e, t) {
            return (a = Object.setPrototypeOf || {
                __proto__: []
            }instanceof Array && function(e, t) {
                e.__proto__ = t
    ...
    668: function(e, t, n) {
        (e.exports = n(583)(!1)).push([e.i, "@media only screen and (max-width:1199px){#notification_container{left:0}}#notification_container{position:absolute;font-size:20px;margin:0 10px;height:30px;overflow:hidden;text-align:center;color:#fff;z-index:51;width:100%}.megamillion #notification_container,.powerball #notification_container{font-size:13px;padding-top:5px}#notification_container ul{position:absolute;list-style:none;white-space:nowrap}#notification_container li{list-style:none;display:inline-block;padding:0 10px;white-space:nowrap}#notification_container li.icon-101,#notification_container li.icon-minipoker{padding-left:25px;background:url(" + n(624) + ") no-repeat 3px 50%;background-size:16px}#notification_container li.icon-103,#notification_container li.icon-taixiu{padding-left:25px;background:url(" + n(625) + ") no-repeat 3px 50%;background-size:16px}#notification_container li.icon-105,#notification_container li.icon-highlow{padding-left:25px;background:url(" + n(626) + ") no-repeat 3px 50%;background-size:16px}#notification_container li.icon-107,#notification_container li.icon-baucua{padding-left:25px;background:url(" + n(623) + ") no-repeat 3px 50%;background-size:16px}#notification_container li.icon-109{padding-left:25px;background:url(" + n(628) + ") no-repeat 3px 50%;background-size:16px}#notification_container li.icon-111{padding-left:25px;background:url(" + n(627) + ") no-repeat 3px 50%;background-size:16px}#notification_container li.icon-115{padding-left:25px;background:url(" + n(629) + ") no-repeat 3px 50%;background-size:16px}#notification_container .account{color:#38ffc8;cursor:pointer}#notification_container .game{color:#ffce58;font-style:italic;font-weight:800}#notification_container .money{color:#ff0}#notification_container .money-1{background:url(/assets/images/portal/m-icon.png) no-repeat 100% 50%;background-size:14px;padding-right:18px}#notification_container .money-0{background:url(/assets/images/portal/x-icon.png) no-repeat 100% 50%;background-size:14px;padding-right:18px;color:#edcea3}", ""])
    },
    690: function(e, t, n) {
        "use strict";
        var a = n(691)
    ...
    691: function(e, t, n) {
        "use strict";
        var a, i = n(0), o = (n.n(i),
        n(692)), l = n(693), r = n(695), s = this && this.__extends || (a = function(e, t) {
            return (a = Object.setPrototypeOf || {
                __proto__: []
            }instanceof Array && function(e, t) {
                e.__proto__ = t
    ...
    744: function(e, t, n) {
        "use strict";
        var a, i = n(0), o = (n.n(i),
        n(4)), l = n(745), r = n.n(l), s = n(2), c = n(12), u = n(329), p = this && this.__extends || (a = function(e, t) {
            return (a = Object.setPrototypeOf || {
                __proto__: []
            }instanceof Array && function(e, t) {
                e.__proto__ = t
    ...
    746: function(e, t, n) {
        ...
        var a, i = n(0), o = (n.n(i),
        n(747)), l = (n.n(o),
        n(4)), r = n(2), s = n(12), c = n(622), u = this && this.__extends || (a = function(e, t) {
            return (a = Object.setPrototypeOf || {
                __proto__: []
            }instanceof Array && function(e, t) {
                e.__proto__ = t
