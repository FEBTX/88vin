webpackJsonp([7], {
    611: function(e, t, a) {
        ...
        var i, r = a(0), o = (a.n(r),
        a(9)), n = a(4), s = a(2), p = a(5), l = a(10), d = a(12), c = a(686), u = (a.n(c),
        ...
        )), h = this && this.__awaiter || function(e, t, a, i) {
        ...
        , g = this && this.__spreadArrays || function() {
            for (var e = 0, t = 0, a = arguments.length; t < a; t++)
                e += arguments[t].length;
            var i = Array(e)
              , r = 0;
            for (t = 0; t < a; t++)
                for (var o = arguments[t], n = 0, s = o.length; n < s; n++,
                r++)
                    i[r] = o[n];
            return i
        }
        , m = function(e) {
            function t(t) {
                    ...
                    return h(a, void 0, void 0, function() {
                        ...
                        return b(this, function(o) {
                            ...
                            case 0:
                                ...
                                [4, fetch("/guide/fans/" + ("vi" === a ? "vi" : "en") + "/" + t)];
                            case 1:
                                return i = o.sent(),
                                r = null,
                                i.ok ? [4, i.text()] : [3, 3];
                ...
                a.showPopup = function() {
                    return h(a, void 0, void 0, function() {
                        ...
                        return b(this, function(s) {
                            switch (s.label) {
                            case 0:
                                for (r in e = this.state.lang,
                                t = window.Config.GUIDE_FANS[e],
                                a = 0,
                                i = null,
                                t)
                                    if (0 === a) {
                                ...
                                return [4, fetch("/guide/fans/" + ("vi" === e ? "vi" : "en") + "/" + t[i])];
                            case 1:
                                return o = s.sent(),
                                n = null,
                                o.ok ? [4, o.text()] : [3, 3];
                ...
                a.showPlay = function() {
                    return h(a, void 0, void 0, function() {
                        ...
                        return b(this, function(a) {
                            ...
                            t = window.Config.FANTASY.HOWTOPLAY[e],
                            this.setState({
                                showPlay: !0,
                                dataPlay: t
                            }),
                ...
                ,
                a.getHistoryTicket = function() {
                    return h(a, void 0, void 0, function() {
                        var e, t, a, i, r, o;
                        return b(this, function(n) {
                            switch (n.label) {
                            case 0:
                                return e = window.Config.EBET_API + "api/fantasy/GetTicketHistory?TopCount=100",
                                [4, Object(p.b)(e)];
                            case 1:
                                return t = n.sent(),
                                a = t.c,
                                i = t.d,
                                0 === a && (r = Math.ceil(i.length / 7),
                                o = 0,
                                i.length > 0 && i.forEach(function(e) {
                                    var t = new Date(e.usedTime)
                                      , a = new Date(e.expireTime);
                                    (1900 === t.getFullYear() || t.getFullYear() < 2021) && a >= new Date && o++
                                }),
                                this.setState({
                                    dataTicket: i,
                                    showTicket: !0,
                ...
                a.state = {
                    ...
                    token: null,
                    userInfo: null,
                    lang: sessionStorage.getItem("fansLang") ? sessionStorage.getItem("fansLang") : "vi",
                    showPopup: !1,
                    showPlay: !1,
                    data: null,
                    inx: -1,
            ...
            t.prototype.loadJs = function(e, t) {
                ...
                n.setAttribute("data-white-label", window.Config.FANTASY.label),
                n.setAttribute("data-token", i),
                n.setAttribute("data-environment", window.Config.FANTASY.environment),
                n.setAttribute("data-currency", window.Config.FANTASY.currency),
                n.setAttribute("data-lang", r),
                n.onload = function() {
                    e.length > 0 ? s.loadJs(e, t) : "function" == typeof t && t.call()
                }
                ,
            ...
            t.prototype.componentDidMount = function() {
                return h(this, void 0, void 0, function() {
                    var e, t, a, i, r, o, n, l, d, c, u, h, g, m, A, w, f, x, y = this;
                    return b(this, function(b) {
                        switch (b.label) {
                        case 0:
                            return b.trys.push([0, 4, , 5]),
                            $("body").addClass("bets fantasy"),
                            [4, s.a.gAI()];
                        case 1:
                            return (e = b.sent()) ? (t = e.c,
                            a = e.d,
                            t < 0 || !a || a.accountID < 1 ? (this.props.history.push("/"),
                            this.props.showLogin(),
                            this.props.unloadingPage(),
                            [2]) : [4, s.a.getFToken()]) : (this.props.history.push("/"),
                            this.props.showLogin(),
                            this.props.unloadingPage(),
                            [2]);
                        case 2:
                            ...
                            this.props.unloadingPage(),
                            [2]) : (n = this.state.lang,
                            l = window.Config.GUIDE_FANS[n],
                            d = window.Config.EBET_API + "api/fantasy/GetTicketHistory?TopCount=100",
                            [4, Object(p.b)(d)]);
                        case 3:
                            for (f in c = b.sent(),
                            u = c.c,
                            h = c.d,
                            0 === u && (g = Math.ceil(h.length / 7),
                            m = 0,
                            h.length > 0 && h.forEach(function(e) {
                                var t = new Date(e.usedTime)
                                  , a = new Date(e.expireTime);
                                (1900 === t.getFullYear() || t.getFullYear() < 2021) && a >= new Date && m++
                            }),
                            this.setState({
                                dataTicket: h,
                                page: 1,
                            ...
                            return this.setHelp(0, l[w]),
                            x = this,
                            setTimeout(function() {
                                var e = sessionStorage.getItem("fansLang");
                                e || (e = n),
                                x.s = [window.Config.FANTASY.url],
                                x.loadJs(x.s),
                                ...
                                $("#header-lang-dropdown li").click(function() {
                                    ...
                                    sessionStorage.setItem("fansLang", e),
                                    window.location.href = window.location.origin + "/#/fantasy",
                ...
                return h(this, void 0, void 0, function() {
                    ...
                    return b(this, function(i) {
                        ...
                        case 1:
                            ...
                            this.props.showLogin(),
                            this.props.unloadingPage(),
                            [2]) : ($(".header-menu-user .money span:first-child").html(d.a.formatNumber(a.goldBalance)),
                            [2])
                        }
                    })
                })
            ...
            t.prototype.componentWillUnmount = function() {
                try {
                    ...
                    $("body").removeClass("fantasy"),
                    this.s.length > 0)
                        for (var e = 0, t = this.s; e < t.length; e++) {
                            var a = t[e];
                            d.a.removejscssfile(a, "js")
                        }
                    this.timer && clearInterval(this.timer)
                } catch (e) {}
            }
            ,
            t.prototype.renderHistoryTicket = function() {
                var e, t = this.state, a = t.page, i = t.dataTicket, o = 7 * (a - 1), n = 7 * a, s = [];
                if (i.length > 7)
                ...
                try {
                    e = s.map(function(e, t) {
                        ...
                        return r.createElement("tr", {
                            ...
                            align: "center"
                        }, a), r.createElement("td", {
                            align: "center"
                        }, d.a.formatTimeSport(o)), r.createElement("td", {
                            align: "center"
                        }, l ? d.a.formatNumber(l) : ""), r.createElement("td", {
                            align: "center"
                        }, 1900 === c.getFullYear() || c.getFullYear() < 2021 ? "" : i), r.createElement("td", {
                            align: "center"
                        }, 1900 === c.getFullYear() || c.getFullYear() < 2021 ? "" : p), r.createElement("td", {
                            align: "center"
                        }, d.a.formatTimeSport(n)), r.createElement("td", {
                            align: "center"
                        }, c.getFullYear() < 2021 ? "" : d.a.formatTimeSport(s)))
                    })
                } catch (e) {}
                return e
            }
            ...
            t.prototype.render = function() {
                var e = this.state
                  ...
                  , c = e.page
                  , u = e.notUsed
                  , h = window.App.account.portalID
                  , b = 4 === h || 6 === h || 7 === h || 8 === h ? 365 : h;
                setTimeout(function() {
                    $(".sp-body").scrollTop(0)
                }, 50);
                var g = this.state.lang
                  , m = sessionStorage.getItem("fansLang");
                m || (m = g);
                var A = c === l ? "disabled" : ""
                  , w = 1 === c ? "disabled" : "";
                return r.createElement(r.Fragment, null, r.createElement("header", {
                    ...
                    src: "/assets/images/logo/logo-" + b + ".png",
                    alt: ""
                })), r.createElement("div", {
                    className: "header-menu-f-ticket",
                    onClick: this.getHistoryTicket
                }, u >= 0 && r.createElement("h6", null, u), r.createElement("span", {
                    id: "btn-header-fticket"
                }, r.createElement("i", {
                    className: "ic-ticket"
                }), " ", r.createElement("b", null, window.Message.GetMessage("sl61")))), r.createElement("div", {
                    className: "menu-wrap"
                }, r.createElement("div", {
                    ...
                    className: "money"
                }, r.createElement("span", null, d.a.formatNumber(t ? t.goldBalance : 0)), r.createElement("span", {
                    className: "ic-money"
                ...
                }), r.createElement("span", null, window.Message.GetMessage("lb32")))), r.createElement("li", {
                    className: "menu-item"
                }, r.createElement("span", {
                    className: "menu-link",
                    onClick: this.showPlay
                }, r.createElement("i", {
                    className: "ic-tutorial"
                }), r.createElement("span", null, window.Message.GetMessage("lb33")))), r.createElement("li", {
                    className: "menu-item"
                }, r.createElement("span", {
                    className: "menu-link",
                    ...
                    className: "ic-guide"
                }), r.createElement("span", null, window.Message.GetMessage("sl19", null, m)))), r.createElement("li", {
                    className: "menu-item"
                }, r.createElement("span", {
                    ...
                    className: "_365 site-popup show",
                    id: "popup"
                }, r.createElement("ul", {
                    ...
                    className: "sph-title"
                }, window.Message.GetMessage("sl19", null, m)), r.createElement("span", {
                    className: "sph-cls",
                    ...
                    className: "sph-title"
                }, window.Message.GetMessage("lb33")), r.createElement("span", {
                    className: "sph-cls",
                    onClick: this.closePopup
                })), r.createElement("div", {
                    className: "sp-body",
                    ...
                    className: "sph-title"
                }, window.Message.GetMessage("lb32")), r.createElement("span", {
                    className: "sph-cls",
                    onClick: this.closePopup
                })), r.createElement("div", {
                    className: "sp-body feed"
                }, r.createElement("iframe", {
                    src: window.Config.FANTASY.FeedBack,
                    title: "feedback",
                    style: {
                        height: "100%",
                        width: "100%"
                    ...
                    className: "sph-title"
                }, window.Message.GetMessage("sl61")), r.createElement("span", {
                    className: "sph-cls",
                    onClick: this.closePopup
                })), r.createElement("div", {
                    className: "sp-body fticket",
                    id: "body-fticket"
                }, r.createElement("table", {
                    className: "tablepress tablepress-id-demo-responsive tablepress-responsive tablepress-responsive-all dataTable no-footer",
                    cellSpacing: "0",
                    cellPadding: "0"
                }, r.createElement("thead", null, r.createElement("tr", null, r.createElement("th", null, window.Message.GetMessage("ev7"), " ID"), r.createElement("th", null, window.Message.GetMessage("lb26")), r.createElement("th", null, window.Message.GetMessage("lb28")), r.createElement("th", null, window.Message.GetMessage("history.tournament")), r.createElement("th", null, window.Message.GetMessage("lb31")), r.createElement("th", null, window.Message.GetMessage("hi46").replace(":", "")), r.createElement("th", null, window.Message.GetMessage("lb27")))), r.createElement("tbody", null, this.renderHistoryTicket())), l >= 2 && r.createElement("div", {
                    className: "pages"
                }, r.createElement("span", {
                    className: w,
                    onClick: this.handleTicketPage.bind(this, -1)
                }, window.Message.GetMessage("lb29")), r.createElement("span", {
                    style: {
                        marginLeft: "5px"
                    },
                    className: A,
                    onClick: this.handleTicketPage.bind(this, 1)
                }, window.Message.GetMessage("lb30")))))), r.createElement("div", {
                    className: "clear"
                }), r.createElement("div", {
                    className: "scout-games-wrapper",
                    style: {
                        height: "calc(100vh - 90px)",
                        marginTop: "90px",
                        fontSize: "14px"
                    }
                }, r.createElement("view-port")))
            }
            ,
            t
        }(r.Component), A = {
