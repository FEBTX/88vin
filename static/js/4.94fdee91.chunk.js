webpackJsonp([4, 11], {
    585: function(e, t, n) {
        ...
        var a, i = n(0),
            ...
            c = n(9),
            u = n(5),
            p = this && this.__extends || (a = function(e, t) {
                ...
                function r(o) {
                    return function(r) {
                        return function(o) {
                            ...
                            for (; l;) try {
                                if (n = 1, a && (i = 2 & o[0] ? a.return : o[0] ? a.throw || ((i = a.return) && i.call(a), 0) : a.next) && !(i = i.call(a, o[1])).done) return i;
                    ...
                    return n.getData = function() {
                        return h(n, void 0, void 0, function() {
                            ...
                            return b(this, function(n) {
                                switch (n.label) {
                                    case 0:
                                        return n.trys.push([0, 2, , 3]), [4, Object(u.c)("/config/quicklink.json")];
                                    case 1:
                        ...
                        libs.MiniGame.isOpen = !libs.MiniGame.isOpen, n.setState({
                            isOpen: !n.state.isOpen
                        }, function() {
                            n.state.isOpen ? ($(".minigame-expand").addClass("show"), e > 0 && $("#noticeVqmmQuickNotOpen").hide()) : ($(".minigame-expand").removeClass("show"), e > 0 && $("#noticeVqmmQuickNotOpen").show())
                        })
                    ...
                    return h(this, void 0, void 0, function() {
                        ...
                        return b(this, function(a) {
                            switch (a.label) {
                                ...
                                case 1:
                                    return e = a.sent(), t = e.c, n = e.d, 0 === t && n > 0 ? this.props.toggleLuckyWheelVip(!0) : (window.Config.isLoadLucky = !0, this.props.getLuckyWheelTurn()), this.getData(), $(".button-toggle-minigame").draggable(), [2]
                            }
                        })
                    })
    ...
    601: function(e, t, n) {
        ...
        var a, i = n(0),
            ...
            v = n(760),
            f = n.n(v),
            g = this && this.__extends || (a = function(e, t) {
                return (a = Object.setPrototypeOf || {
                        __proto__: []
                    }
                    instanceof Array && function(e, t) {
            ...
            y = this && this.__awaiter || function(e, t, n, a) {
                return new(n || (n = Promise))(function(i, o) {
                    function l(e) {
                        try {
                            s(a.next(e))
            ...
            E = this && this.__spreadArrays || function() {
                ...
                var a = Array(e),
                    i = 0;
                for (t = 0; t < n; t++)
                    for (var o = arguments[t], l = 0, r = o.length; l < r; l++, i++) a[i] = o[l];
                return a
            },
            N = Object(l.a)({
                loader: function() {
            ...
            k = function(e) {
                function t(t) {
                    var n = e.call(this, t) || this;
                    return n.getGameID = function() {
                        try {
                            var e = n.props.match.params.game;
                            return "tlmn" == e ? f.a.tlmn_dl.id : "tlmn_solo" == e ? f.a.tlmn_dl_solo.id : f.a[e].id
                        } catch (e) {
                            console.log(e)
                        }
                    }, n.updateRoomType = function(e) {
                        $(".rooms .room-block").hide(), $(".rank .content .rank-lists").hide(), n.setState({
                            rankType: e
                        }), setTimeout(function() {
                            $(".rooms .room-block").show(), $(".rank .content .rank-lists").show()
                        }, 200)
                ...
                return g(t, e), t.prototype.componentWillMount = function() {
                    return y(this, void 0, void 0, function() {
                        ...
                        return w(this, function(t) {
                            return this.props.loadingPage(), e = this, window.App.handleBack = function() {
                                e.props.showBack(e.props.history), e.props.gAI(), document.body.classList.remove("cardingame"), window.Config.inCardGame = !1
                                ...
                                var n = e.props.match.params.game,
                                    ...
                                    o = t.chip,
                                    l = t.auto;
                                o ? e.props.history.push("/casino/" + n + "/" + a + "/" + i + "/" + o + "/" + l) : e.props.history.push("/casino/" + n + "/" + a + "/" + i)
                            }, window.App.exitGame = function() {
                    ...
                    return y(this, void 0, void 0, function() {
                        return w(this, function(e) {
                            ...
                            try {
                                window.Config.inCardGame = !1, this.game && this.game.stop && this.game.stop(), this.game && this.game.delete && this.game.delete(), this.gameConfig && this.gameConfig.files && this.gameConfig.files.map(function(e, t) {
                    ...
                    return y(this, void 0, void 0, function() {
                        var e, t, n, a, i, l, r, s, c = this;
                        return w(this, function(u) {
                            switch (u.label) {
                                case 0:
                                    return [4, o.a.gAI()];
                                case 1:
                                    return e = u.sent(), t = e.c, n = e.d, t < 0 || !n || n.accountID < 1 ? (this.props.history.push("/"), this.props.showLogin(), this.props.unloadingPage(), [2]) : (a = this.props.match.params, i = a.game, l = a.value, r = a.type, this.gameConfig = window.Config.ConfigGames[i], this.gameConfig ? (sessionStorage.setItem("GAME_TAB", "casino"), window.dispatchEvent(new Event("resize")), this.setState({
                                        showLoading: !0,
                                        mounted: !0
                                    }), s = E(this.gameConfig.files), this.loadJs(s, function() {
                                        try {
                                            var e = o.i.getAccessToken(),
                                                t = o.i.getCurrency();
                                            window[c.gameConfig.hubName] = c.gameConfig.url, c.game = new window[c.gameConfig.name].game({
                                                size: [window.innerWidth, window.innerHeight],
                                                target: c.gameConfig.element,
                                                token: e,
                                                currencyID: t
                                            }), c.game.load(function() {
                                                c.setState({
                                                    showLoading: !1
                                                }), l && r && (window.Config.inCardGame = !0, c.game.join(l, r)), document.body.classList.add("cardingame")
                                            })
                                        } catch (e) {
                                            c.setState({
                                                showLoading: !1
                                        ...
                                        c.props.unloadingPage()
                                    }), [2]) : (this.props.history.push("/"), this.props.unloadingPage(), [2]))
                            }
                        })
                    })
                    ...
                    var n = e.shift(),
                        ...
                        i = this;
                    a.setAttribute("src", n), a.onload = function() {
                        e.length > 0 ? i.loadJs(e, t) : "function" == typeof t && t.call()
                    }, document.body.appendChild(a)
                }, t.prototype.componentWillReceiveProps = function(e) {
                    if (this.state.mounted) try {
                        if (!e.isAuthen) return void this.props.history.push("/")
                    } catch (e) {
                        console.log(e)
                    }
                }, t.prototype.componentDidUpdate = function(e) {
                    if (this.game && this.game.game.isLoad) {
                        var t = this.props.match.params,
                            n = t.value,
                            a = t.type;
                        if (!n || !a) return window.Config.inCardGame = !1, void(this.game.delete && this.game.game.ready && this.game.delete());
                        var i = e.match.params,
                            o = i.value,
                            l = i.type;
                        o == n && l == a || (this.game.game.ready = !1, this.game.join(n, a), window.Config.inCardGame = !0)
                    }
                }, t.prototype.render = function() {
                    var e = this.props.match.params,
                        ...
                        b = "",
                        d = !0;
                    this.gameConfig && (u = this.gameConfig.element, b = this.gameConfig.gameName), t && n && (d = !1);
                    var v = this.getGameID();
                    return i.createElement("div", null, i.createElement("div", {
                        className: "app",
                        style: {
                            display: d ? "block" : "none"
                        }
                    }, i.createElement(N, A({}, this.props)), i.createElement("div", {
                        className: "main"
                    }, i.createElement("span", {
                        className: "shadow-horizontal"
                    }), i.createElement("div", {
                        className: "annoucement"
                    }, i.createElement(p.a, A({}, this.props))), window.Config.ENABLE_MAIL && i.createElement("div", {
                        className: "version"
                        ...
                        className: "button button-room-type button-room-vip" + (1 === l ? " active" : ""),
                        onClick: this.updateRoomType.bind(this, 1)
                    }, i.createElement("span", null, i.createElement(m.b, {
                        id: "tb112"
                    }))), i.createElement("span", {
                        className: "button button-room-type button-room-normal" + (0 === l ? " active" : ""),
                        onClick: this.updateRoomType.bind(this, 0)
                    }, i.createElement("span", null, i.createElement(m.b, {
                        id: "tb113"
                    })))), i.createElement("div", {
                        className: "room-title"
                    }, i.createElement("p", null, b && i.createElement(m.b, {
                        id: b
                    })), i.createElement("span", {
                        ...
                        className: "ic-guide"
                    }))), i.createElement(r.a, A({}, this.props)), i.createElement(s.a, A({}, this.props, {
                        gameName: b,
                        showLoading: o,
                        rType: l,
                        gameType: "casino"
                    ...
                    }))), i.createElement(h.b, null)), i.createElement("div", {
                        id: u,
                        style: {
    ...
    658: function(e, t, n) {
        ...
        var a, i = n(0),
            ...
            l = n(706),
            r = n(9),
            s = this && this.__extends || (a = function(e, t) {
                return (a = Object.setPrototypeOf || {
                        __proto__: []
                    }
                    instanceof Array && function(e, t) {
    ...
    673: function(e, t, n) {
        ...
        var a, i = n(0),
            ...
            s = n(12),
            c = n(632),
            u = this && this.__extends || (a = function(e, t) {
                return (a = Object.setPrototypeOf || {
                        __proto__: []
                    }
                    instanceof Array && function(e, t) {
            ...
            d = function(e) {
                function t(t) {
                        ...
                        if (!(n.dataNotify.length <= 0)) {
                            for (var l = 0, r = 0, u = n.dataNotify; r < u.length; r++) {
                                ...
                                for (var v = 0, f = d.split(";"); v < f.length; v++) {
                                    ...
                                    if (o = b(o, [m]), ++l > 20) break
                                }
                                if (l > 20) break
                            }
                            return o.length <= 2 && (a = 3 * t), n.timer = setTimeout(function() {
                                n.animate(a)
                            }, 500), n.setStyle(), o
                        }
                    }, n.setStyle = function() {}, n.animate = function(e) {
                        try {
                            if (null === document.getElementById("notification_container")) return;
                            ...
                            a = $("#notification_container ul").width(), $("#notification_container ul").animate({
                                left: -a + "px"
                            }, {
                                duration: e,
                                easing: "linear",
                                done: function() {
                                    $("#notification_container ul").css("left", "1500px"), n.dataNotify != n.newNotify && (n.dataNotify = n.newNotify, n.setState({
                                        data: n.dataNotify
                                    }), n.newNotify = [])
                                }
                            })
                    ...
                    }, n.getGame(), n.dataNotify = [], n.newNotify = [], n.state = {
                        data: [],
                        newdata: [],
                        isMounted: !1,
                        ulWidth: 0,
                ...
                return u(t, e), t.prototype.getGame = function() {
                    return p(this, void 0, void 0, function() {
                        var e, t;
                        return h(this, function(n) {
                            switch (n.label) {
                                case 0:
                                    return window.Config && window.Config.Games ? (this.map = window.Config.Games, [3, 4]) : [3, 1];
                                case 1:
                                    return [4, fetch("/config/games.json")];
                                case 2:
                                    return e = n.sent(), t = this, [4, e.json()];
                                case 3:
                                    t.map = n.sent(), window.Config.Games = this.map, n.label = 4;
                                case 4:
                                    return [2]
                            }
                        })
                    ...
                    !this.state.isMounted && n && (this.setState({
                        isMounted: !0
                    }), window.ChatConnection.off("notifyMessage"), window.ChatConnection.on("notifyMessage", function(e) {
                        t.onReceiveNotify(e)
                    }))
            ...
            u = function(e) {
                function t(t) {
                    ...
                    return n.changeTag = function(e) {
                        "hot" === e && sessionStorage.removeItem("GAME_TAB"), n.setState({
                            tag: e,
                            showArrow: "hot" === e
                        })
    ...
    696: function(e, t, n) {
        ...
        var a, i = n(0),
            ...
            r = n(10),
            s = n(9),
            c = this && this.__extends || (a = function(e, t) {
                return (a = Object.setPrototypeOf || {
                        __proto__: []
                    }
                    instanceof Array && function(e, t) {
            ...
            b = function(e) {
                function t(t) {
                    var n = e.call(this, t) || this;
                    return n.arrGameAuto = {}, n.jackList = [
                        [null, null, null],
                        [null, null, null],
                        [null, null, null],
                        [null, null, null],
                        ...
                        return u(n, void 0, void 0, function() {
                            ...
                            return p(this, function(p) {
                                switch (p.label) {
                                    case 0:
                                        return p.trys.push([0, 2, , 3]), clearTimeout(this.timer), [4, o.d.getListJackpot()];
                                    case 1:
                                        if (e = p.sent(), t = e.c, n = e.d, a = this.state.slot, t < 0) return [2];
                                        if (n && n.length > 0)
                                            for (i = 0; i < a.length; i++)
                                                if ((l = a[i]).jackpot)
                                                    for (r = 0, s = n; r < s.length; r++)(c = s[r]).gameID == l.id && this.countJackpot(l.id, c.roomID, i, c.jackpotFund);
                                        return this.timer = setTimeout(function() {
                                            return h.getListJackpot()
                                        }, window.Config.TIME_COUNT_JACKPOT_LOBBY), [3, 3];
                                    case 2:
                                        return u = p.sent(), console.log(u), [3, 3];
                                    case 3:
                                        return [2]
                                }
                            })
                        ...
                        return u(n, void 0, void 0, function() {
                            ...
                            return p(this, function(i) {
                                switch (i.label) {
                                    case 0:
                                        return i.trys.push([0, 5, , 6]), window.Config && window.Config.Games ? (e = window.Config.Games, [3, 4]) : [3, 1];
                                    case 1:
                                        return [4, fetch("/config/games.json")];
                                    case 2:
                                        return [4, i.sent().json()];
                                    case 3:
                                        e = i.sent(), window.Config.Games = e, i.label = 4;
                                    case 4:
                                        return this.setState({
                                            loading: !1
                                        }), t = [], Object.keys(e).map(function(n, a) {
                                            "slot" === e[n].tag && e[n].jackpot && (t = h(t, [e[n]]))
                                        }), this.slots = t, this.sports = [], Object.keys(e).map(function(t, n) {
                                    ...
                                    case 5:
                                        return n = i.sent(), console.error(n), [3, 6];
                                    case 6:
                                        return this.setState({
                                            loading: !1
                                        }), [2]
                        ...
                        if ("hot" === e)
                            if (i.length > 0 && window.Config.RandomPos)
                                for (var r = 0, s = i; r < s.length; r++)
                                    ...
                                    } else Object.keys(t).map(function(e, n) {
                                        a = h(a, [t[e]])
                                    });
                            else Object.keys(t).map(function(n, i) {
                                t[n].tag === e && (a = h(a, [t[n]]))
                            });
                        var d = "";
                        ...
                        for (var m = 0, v = 0, f = 0; f < a.length; f++) {
                            var g = a[f];
                            if (g.display) {
                                if (0 === m && 0 === v && (d += '<div class="game-slider">'), 1 === g.row ? d += '<div class="game-column one-row">' : 0 === v && (d += '<div class="game-column two-row">'), g.url && "football" === e ? d += '<a href="' + g.url.replace("{0}", window.App.account.username).replace("{1}", o.i.getSessionToken()) + '" target="_blank">' : g.link && "football" === e ? d += '<a href="' + g.link.replace("{0}", o.i.getAccessToken()) + '" tartget="' + g.target + '">' : g.link ? d += '<a href="/#' + g.link + '">' : d += '<a href="' + g.href + '">', d += '<span id="mn-lobby-rolling-' + g.gameName + '" class="game game-row ' + g.class + '">', d += '<span class="' + ("football" === e ? g.cssClass : "name-" + g.class) + '"></span>', g.jackpot) {
                                    d += '<div class="jackpots" id="' + g.id + '">';
                                    for (var A = 3, y = 1; y < 4; y++) d += '<div class="jackpot-' + y + '" id="lobby-jp-' + g.id + "-" + A + '"><span id="game-' + g.id + "-" + A + '">0</span></div>', A--;
                                    d += "</div>"
                                }
                                d += "</span></a>", g.jackpot && (d += '<span class="rolling" id="rolling-' + g.gameName + '" data-id="' + g.id + '"></span>'), 2 === g.row && v++, (1 === g.row || 2 === g.row && 2 === v || 2 === g.row && f === a.length - 1 && a.length % 2 === 1) && (d += "</div>", m++), 2 === v && (v = 0), (6 === m || f === a.length - 1 && a.length % 2 === 1) && (d += "</div>", m = 0, v = 0)
                            }
                        }
                        return d += "</div>"
                    }, n.renderIndicator = function() {
                        for (var e = n.state, t = e.number_tag, a = e.activeTab, o = [], l = 0; l < t; l++) o.push(i.createElement("li", {
                            key: l,
                ...
                return c(t, e), t.prototype.componentDidMount = function() {
                    ...
                    if (t) {
                        var n = t.split(";");
                        return (-1 === parseInt(n[1]) || parseInt(n[1]) > 0) && "true" === n[2] || (sessionStorage.removeItem("Auto-" + e), !1)
                    }
                    return !1
                    ...
                    if (this.slots) {
                        ...
                        for (var n = 0, a = this.slots; n < a.length; n++) {
                            var i = a[n];
                            i.gameName !== this.state.game && this.checkAutoGame(i.gameName) && (e = !0, this.loadGameSilent(i.gameName), t += "<span style='color:yellow; font-size: 28px; padding: 10px 0px; display: block'>" + window.Message.GetMessage(l.a.gameIDtoName(i.id, window.Config.PortalID)) + "</span>")
                        }
                        e && (t += "<br />" + window.Message.GetMessage("sl93"), window.App.showPopupMessage({
                            content: t,
                            textDone: "OK"
                    ...
                    this.loadJs(a, function() {
                        var e = o.i.getAccessToken(),
                            ...
                            l = i.hub,
                            r = i.url;
                        a || (a = l[libs.Util.RandomFrom(0, l.length - 1)], sessionStorage.setItem(n + "hubUrl", a)), t.arrGameAuto[n] = new window[n].game({
                            size: [window.innerWidth, window.innerHeight],
                            target: null,
                            token: e,
                            getHistory: null,
                    ...
                    for (var e = 0; e < window.Config.jackList.length; e++) window.Config.jackList[e] = [null, null, null]
                }, t.prototype.componentDidUpdate = function() {
                    var e = this,
                        t = this.props.tag,
                        n = this.state.slot;
                    ...
                    if (this.slots)
                        for (var t = 0, n = this.slots; t < n.length; t++) {
                            var a = n[t];
                            $("#rolling-" + a.gameName).removeClass("active"), window.arrSlots && window.arrSlots[a.gameName] && (window.arrSlots[a.gameName].game.isAuto ? $("#rolling-" + a.gameName).addClass("active") : $("#rolling-" + a.gameName).removeClass("active")), $("#rolling-" + a.gameName).unbind("click").click(function() {
                    ...
                    for (var t = 0, n = this.slots; t < n.length; t++) {
                        ...
                        if (a.id === e) {
                            var i;
                            if (window.Config.activeSlot === e) return void((i = window.App.gameSlots).checkAuto() ? i.stopAuto() : i.startAuto() || (window.App.gameSlots && window.App.gameSlots.setSilent(), window.location.href = "#" + a.link));
                            if (window.arrSlots[a.gameName])(i = window.arrSlots[a.gameName]) && i.checkAuto() ? (i.stopAuto(), this.showAuto()) : i && i.startAuto() ? $("#rolling-" + a.gameName).addClass("active") : this.props.history.push(a.link);
                            break
                        }
                    }
                }, t.prototype.countJackpot = function(e, t, n, a) {
                    this.jackList[n][t - 1] ? this.jackList[n][t - 1].update(a) : (this.jackList[n][t - 1] = new libs.Util.CountUp("game-" + e + "-" + t, !1, !1, 0, a, 0, 1, void 0), this.jackList[n][t - 1].start())
                    ...
                    return n.getData = function() {
                        return h(n, void 0, void 0, function() {
                            ...
                            return b(this, function(n) {
                                switch (n.label) {
                                    case 0:
                                        return n.trys.push([0, 2, , 3]), [4, Object(o.c)("/config/banner.json")];
                                    case 1:
                                        return e = n.sent(), this.setState({
                                            data: e || []
                                        }), [3, 3];
        ...
        window, a = function(e) {
            return function(e) {
                ...
                (function(e) {
                        ...
                        update: function(e, t) {
                            ...
                            for (e = void 0 !== e ? e : i.now(); n.length > 0;) {
                                ...
                                for (var a = 0; a < n.length; a++) {
                                    ...
                                    o && !1 === o.update(e) && (o._isPlaying = !1, t || delete this._tweens[n[a]])
                                }
                    ...
                    var a, i = new n;
                    i.Group = n, i._nextId = 0, i.nextId = function() {
                        return i._nextId++
                        ...
                        this._object = e, this._valuesStart = {}, this._valuesEnd = {}, this._valuesStartRepeat = {}, this._duration = 1e3, this._repeat = 0, this._repeatDelayTime = void 0, this._yoyo = !1, this._isPlaying = !1, this._reversed = !1, this._delayTime = 0, this._startTime = null, this._easingFunction = i.Easing.Linear.None, this._interpolationFunction = i.Interpolation.Linear, this._chainedTweens = [], this._onStartCallback = null, this._onStartCallbackFired = !1, this._onUpdateCallback = null, this._onRepeatCallback = null, this._onCompleteCallback = null, this._onStopCallback = null, this._group = t || i, this._id = i.nextId()
                    }, i.Tween.prototype = {
                        getId: function() {
                            return this._id
                        },
                        ...
                        update: function(e) {
                            ...
                            for (t in !1 === this._onStartCallbackFired && (null !== this._onStartCallback && this._onStartCallback(this._object), this._onStartCallbackFired = !0), n = (e - this._startTime) / this._duration, n = 0 === this._duration || n > 1 ? 1 : n, a = this._easingFunction(n), this._valuesEnd)
                                if (void 0 !== this._valuesStart[t]) {
                                    var i = this._valuesStart[t] || 0,
                                        o = this._valuesEnd[t];
                                    o instanceof Array ? this._object[t] = this._interpolationFunction(o, a) : ("string" == typeof o && (o = "+" === o.charAt(0) || "-" === o.charAt(0) ? i + parseFloat(o) : parseFloat(o)), "number" == typeof o && (this._object[t] = i + (o - i) * a))
                                }
                            if (null !== this._onUpdateCallback && this._onUpdateCallback(this._object, n), 1 === n) {
                                if (this._repeat > 0) {
                                    for (t in isFinite(this._repeat) && this._repeat--, this._valuesStartRepeat) {
                                        if ("string" == typeof this._valuesEnd[t] && (this._valuesStartRepeat[t] = this._valuesStartRepeat[t] + parseFloat(this._valuesEnd[t])), this._yoyo) {
                                            ...
                                            this._valuesStartRepeat[t] = this._valuesEnd[t], this._valuesEnd[t] = l
                                        }
                                ...
                                for (var r = 0, s = this._chainedTweens.length; r < s; r++) this._chainedTweens[r].start(this._startTime + this._duration);
                                return !1
                            }
                            return !0
                        }
                        ...
                        Bezier: function(e, t) {
                            for (var n = 0, a = e.length - 1, o = Math.pow, l = i.Interpolation.Utils.Bernstein, r = 0; r <= a; r++) n += o(1 - t, a - r) * o(t, r) * e[r] * l(a, r);
                            return n
                        },
                        CatmullRom: function(e, t) {
                            ...
                            return e[0] === e[n] ? (t < 0 && (o = Math.floor(a = n * (1 + t))), l(e[(o - 1 + n) % n], e[o], e[(o + 1) % n], e[(o + 2) % n], a - o)) : t < 0 ? e[0] - (l(e[0], e[0], e[1], e[1], -a) - e[0]) : t > 1 ? e[n] - (l(e[n], e[n], e[n - 1], e[n - 1], a - n) - e[n]) : l(e[o ? o - 1 : 0], e[o], e[n < o + 1 ? n : o + 1], e[n < o + 2 ? n : o + 2], a - o)
                        },
                        Utils: {
                    ...
                    for (var n = {}, a = [], i = 0; i < e.length; i++) {
                        ...
                        var p = l(u),
                            h = {
                                ...
                                media: r[2],
                                sourceMap: r[3]
                            }; - 1 !== p ? (o[p].references++, o[p].updater(h)) : o.push({
                            identifier: u,
                            updater: d(h, t),
                            references: 1
                        }), a.push(u)
                ...
                e.exports = function(e) {
                    ...
                    return t.toString = function() {
                        return this.map(function(t) {
                            var n = function(e, t) {
                                ...
                                if (t && "function" == typeof btoa) {
                                    var r = (n = l, a = btoa(unescape(encodeURIComponent(JSON.stringify(n)))), i = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(a), "/*# ".concat(i, " */")),
                        ...
                        for (var r = 0; r < e.length; r++) {
                            var s = [].concat(e[r]);
                            a && i[s[0]] || (n && (s[2] ? s[2] = "".concat(n, " and ").concat(s[2]) : s[2] = n), t.push(s))
                        }
                    }, t
                }
            }, function(e, t, n) {
                ...
                function h() {
                    u && s && (u = !1, s.length ? c = s.concat(c) : p = -1, c.length && b())
                }
                ...
                i.nextTick = function(e) {
                    ...
                    c.push(new d(e, t)), 1 !== c.length || u || r(b)
                ...
                function s(e, t) {
                    ...
                    return Object.keys(t).reduce(function(e, a) {
                        return -1 === n.indexOf(a) && (e[a] = t[a]), e
                    }, {})
                }
                ...
                var d = function(e) {
                    function t(e) {
                        ...
                        }, n.width = 0, n.imageContainer = null, n.wrapper = null, n.timeout = null, n.moveSlides = n.moveSlides.bind(h(n)), n.pauseSlides = n.pauseSlides.bind(h(n)), n.startSlides = n.startSlides.bind(h(n)), n.resizeListener = n.resizeListener.bind(h(n)), n.goToSlide = n.goToSlide.bind(h(n)), n.tweenGroup = new o.a.Group, n
                    }
                    var n, a;
                    return function(e, t) {
                        ...
                        value: function() {
                            var e = this;
                            this.setWidth(), window.addEventListener("resize", this.resizeListener);
                            var t = this.props,
                                n = t.autoplay,
                                a = t.duration;
                        ...
                        value: function() {
                            this.willUnmount = !0, clearTimeout(this.timeout), window.removeEventListener("resize", this.resizeListener)
                        }
                    }, {
                        key: "setWidth",
                        value: function() {
                            ...
                            this.imageContainer.style.width = "".concat(e, "px"), this.imageContainer.style.transform = "translate(-".concat(this.width * (this.state.index + 1), "px)"), this.applySlideStyle()
                        }
                    }, {
                        ...
                        value: function(e) {
                            ...
                            this.props.autoplay !== e.autoplay && (this.props.autoplay ? this.timeout = setTimeout(function() {
                                return t.goNext()
                            }, this.props.duration) : clearTimeout(this.timeout)), this.props.children.length != e.children.length && this.setWidth()
                        }
                    }, {
                        key: "resizeListener",
                        value: function() {
                        ...
                        value: function() {
                            var e = this.props,
                                ...
                                a = e.infinite,
                                o = "";
                            return n || (o = "nav ".concat(this.state.index <= 0 && !a && "disabled")), t && i.a.createElement("div", {
                                className: o,
                                "data-type": "prev",
                        ...
                        value: function() {
                            var e = this.props,
                                ...
                                o = e.children,
                                l = "";
                            return n || (l = "nav ".concat(this.state.index === o.length - 1 && !a && "disabled")), t && i.a.createElement("div", {
                                className: l,
                                "data-type": "next",
                                onClick: this.moveSlides
                            }, n || i.a.createElement("span", null))
                        ...
                        value: function() {
                            var e = this,
                                ...
                                l = (n.arrows, s(t.propTypes, this.props)),
                                r = this.state.index,
                                c = {
                        ...
                        value: function(e) {
                            ...
                            if (!this.tweenGroup.getAll().length) {
                                ...
                                ! function e() {
                                    t.willUnmount ? t.tweenGroup.removeAll() : (requestAnimationFrame(e), t.tweenGroup.update())
                                }(), p.onComplete(function() {
                                    var n = e < 0 ? a.length - 1 : e >= a.length ? 0 : e;
                                    t.willUnmount || ("function" == typeof c && c(t.state.index, n), t.setState({
                                        index: n
                                    }, function() {
                ...
                var w = function(e) {
                    function t(e) {
                        ...
                        return function(e, t) {
                            ...
                            index: e.defaultIndex && e.defaultIndex < e.children.length ? e.defaultIndex : 0
                        }, n.width = 0, n.timeout = null, n.divsContainer = null, n.wrapper = null, n.setWidth = n.setWidth.bind(A(n)), n.resizeListener = n.resizeListener.bind(A(n)), n.navigate = n.navigate.bind(A(n)), n.preFade = n.preFade.bind(A(n)), n.pauseSlides = n.pauseSlides.bind(A(n)), n.startSlides = n.startSlides.bind(A(n)), n.tweenGroup = new o.a.Group, n
                    }
                    var n, a;
                    return function(e, t) {
                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
                        ...
                        key: "componentDidMount",
                        value: function() {
                            window.addEventListener("resize", this.resizeListener), this.setWidth(), this.play()
                        }
                    }, {
                        key: "play",
                        value: function() {
                            var e = this,
                                ...
                                a = t.children,
                                i = this.state.index;
                            n && a.length > 1 && (clearTimeout(this.timeout), this.timeout = setTimeout(function() {
                        ...
                        key: "componentDidUpdate",
                        value: function(e) {
                            this.props.autoplay !== e.autoplay && (this.props.autoplay ? this.play() : clearTimeout(this.timeout)), this.props.children.length != e.children.length && (this.applyStyle(), this.play())
                        }
                    }, {
                        key: "componentWillUnmount",
                        value: function() {
                        ...
                        value: function() {
                            ...
                            for (var t = 0; t < this.divsContainer.children.length; t++) {
                                ...
                                n && (n.style.width = "".concat(this.width, "px"), n.style.left = "".concat(t * -this.width, "px"))
                            }
                        }
                    }, {
                        key: "pauseSlides",
                        ...
                        value: function(e) {
                            var t = this,
                                ...
                                u = a.onChange;
                            this.tweenGroup.getAll().length || (this.divsContainer.children[e] || (e = 0), clearTimeout(this.timeout), function e() {
                                t.willUnmount ? t.tweenGroup.removeAll() : (requestAnimationFrame(e), t.tweenGroup.update())
                            }(), new o.a.Tween({
                                opacity: 0
                            }, this.tweenGroup).to({
                                ...
                                t.divsContainer.children[e].style.opacity = a.opacity, t.divsContainer.children[n].style.opacity = 1 - a.opacity
                            }).start().onComplete(function() {
                                t.willUnmount || (t.setState({
                                    index: e
                                }), "function" == typeof u && u(n, e), i && (r || e < l.length - 1) && (clearTimeout(t.timeout), t.timeout = setTimeout(function() {
                ...
                var M = function(e) {
                    function t(e) {
                        ...
                        return function(e, t) {
                            ...
                            index: e.defaultIndex && e.defaultIndex < e.children.length ? e.defaultIndex : 0
                        }, n.width = 0, n.timeout = null, n.divsContainer = null, n.wrapper = null, n.setWidth = n.setWidth.bind(x(n)), n.resizeListener = n.resizeListener.bind(x(n)), n.navigate = n.navigate.bind(x(n)), n.preZoom = n.preZoom.bind(x(n)), n.pauseSlides = n.pauseSlides.bind(x(n)), n.startSlides = n.startSlides.bind(x(n)), n.tweenGroup = new o.a.Group, n
                    }
                    var n, a;
                    return function(e, t) {
                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
                        ...
                        value: function() {
                            var e = this,
                                n = this.props,
                                a = n.indicators,
                                o = (n.arrows, n.infinite, n.children),
                                l = this.state.index,
                                r = s(t.propTypes, this.props);
                            return i.a.createElement("div", r, i.a.createElement("div", {
                                className: "react-slideshow-container",
                        ...
                        value: function(e) {
                            ...
                            this.tweenGroup.getAll().length || (this.divsContainer.children[e] || (e = 0), clearTimeout(this.timeout), function e() {
                                ...
                                t.divsContainer.children[e].style.opacity = a.opacity, t.divsContainer.children[n].style.opacity = 1 - a.opacity, t.divsContainer.children[n].style.transform = "scale(".concat(a.scale, ")")
                            }).start().onComplete(function() {
                                t.willUnmount || ("function" == typeof p && p(n, e), t.setState({
                                    index: e
                                }, function() {
                                    t.divsContainer.children[n].style.transform = "scale(1)"
                                }), r && (s || e < i.length - 1) && (clearTimeout(t.timeout), t.timeout = setTimeout(function() {
    ...
    699: function(e, t, n) {
        ...
        var a, i = n(0),
            o = (n.n(i), n(4)),
            l = this && this.__extends || (a = function(e, t) {
                return (a = Object.setPrototypeOf || {
                        __proto__: []
                    }
                    instanceof Array && function(e, t) {
            ...
            p = function(e) {
                function t(t) {
                    ...
                    return n.handleShowVoice = function() {
                        ...
                        sessionStorage.setItem("TRANSFER_STORAGE", window.Config.PortalID + ";1"), n.props.showProfile(s.k.TRANSFER)
                ...
                return u(t, e), t.prototype.handleShowProfile = function(e) {
        ...
        (function(e) {
            var a, i = n(0),
                ...
                u = function(t) {
                    function n(e) {
                        ...
                        return n.handleInputChange = function(e) {
                            ...
                            if (e.preventDefault(), 13 === e.keyCode) {
                                var t = n.form,
                                    a = t.txtPassword;
                                if ("" == t.txtUsername) return void n.nameInput.focus();
                                if ("" == a) return void n.passwordInput.focus();
                                n.handleLogin(e)
                            }
                            ...
                            if (n.props.profileManager.tag != r.k.SHOW_UPDATE_NICKNAME) {
                                var l = !1,
                                    s = "";
                                if (null !== i && "" !== i.trim() || null !== a && "" !== a.trim() || (l = !0, s += o.formatMessage({
                                        id: "me-1092"
                                    })), l) n.props.showMessage({
                                    content: s,
                                    textDone: "OK"
                                });
                                else {
                    ...
                    return c(n, t), n.prototype.handleOpenIDLogin = function(t) {
                ...
                return p(t, e), t.prototype.componentWillMount = function() {
                    return h(this, void 0, void 0, function() {
                        ...
                        return b(this, function(o) {
                            switch (o.label) {
                                case 0:
                                    return o.trys.push([0, 2, , 3]), [4, u.a.getAllBalance()];
                                case 1:
                                    return e = o.sent(), t = e.c, n = e.d, t < 0 ? [2] : (a = 1 === n.length, this.setState({
                                        isSingle: a
                                    }), [3, 3]);
                                case 2:
                                    return i = o.sent(), console.log(i), [3, 3];
                                case 3:
                                    return [2]
                            }
                        })
            ...
            h = function(e) {
                function t(t) {
                    ...
                    return n.updateScroll = function() {
                        ...
                        var e = n.props.match.params.game;
                        return console.log("getChannelLobby", e), "tlmn" == e ? "tlmn_dl_lobby" : "tlmn_solo" == e ? "tlmn_dl_solo_lobby" : "xocdia" == e ? "sedie_lobby" : "sicbo" == e ? "casinosicbo_lobby" : e + "_lobby"
                    }, n.handleKeyUp = function(e) {
                        e.preventDefault(), 13 === e.keyCode && n.sendMessage()
                ...
                return u(t, e), t.prototype.componentDidMount = function() {
                    ...
                    this.scroll.current && this.scroll.current.scrollToBottom(), $(".chat.lobbyChat .messages").slimScroll({
                        top: "60px",
                        height: "400px",
                    ...
                    if (this.state.isMounted) {
                        ...
                        this.initChat(e), this.register(i, e)
                    }
                    ...
                    try {
                        ...
                        if (this.state.isUpdated || !a) return;
                        this.setState({
                            isUpdated: !0
                        }), window.ChatConnection.invoke("registerChat", {
                            ChannelID: e
            ...
            b = function(e) {
                function t(t) {
                    ...
                    return n.toggleTable = function(e) {
                        ...
                        if (n.props.handleRoomClick) n.props.handleRoomClick(e, t);
                        else {
                    ...
                    return n.getLeaderBoard = function() {
                        return p(n, void 0, void 0, function() {
                            ...
                            return h(this, function(l) {
                                switch (l.label) {
                                    case 0:
                                        return l.trys.push([0, 2, , 3]), e = this.props.gameID, t = this.state.rankMoneyType, [4, r.h.getLeaderBoard(e, t)];
                                    case 1:
                                        return n = l.sent(), a = n.c, i = n.d, a < 0 ? [2] : (this.setState({
                                            data: i
                                        }), [3, 3]);
                                    case 2:
                                        return o = l.sent(), console.log(o), [3, 3];
                                    case 3:
                                        return [2]
                                }
                            })
                        ...
                        var e = n.state.data;
                        if (e) return e.slice(0, 7).map(function(e, t) {
                            var n = e.nickname,
                                a = e.totalMoneyWins,
                                o = e.avatar,
                                l = "" + s.a.getAvatar(o);
