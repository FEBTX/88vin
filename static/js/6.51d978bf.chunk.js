        ...
        , h = function(e) {
            function t(t) {
                    ...
                    return b(a, void 0, void 0, function() {
                        ...
                        return u(this, function(i) {
                            ...
                            case 0:
                                ...
                                [4, fetch("guide/ultra/guide-" + ("vi" === e ? "vi" : "en") + ".html")];
                            case 1:
                                return t = i.sent(),
                                a = null,
                                t.ok ? [4, t.text()] : [3, 3];
                ...
                a.state = {
                    ...
                    userInfo: null,
                    showPopup: !1,
                    lang: sessionStorage.getItem("ultraLang") ? sessionStorage.getItem("ultraLang") : "vi"
                },
                a
            }
            return c(t, e),
            ...
            t.prototype.getLang = function(e) {
                return "vi" === e ? "vi-VN" : "zh" === e ? "zh-CN" : "id" === e ? "id-ID" : "km" === e ? "km-KH" : "th" === e ? "th-TH" : "en-US"
            }
            ,
            t.prototype.componentDidMount = function() {
                return b(this, void 0, void 0, function() {
                    var e, t, a, i, r, o, n, s = this;
                    return u(this, function(l) {
                        ...
                        case 0:
                            ...
                            [4, p.a.gAI()];
                        case 1:
                            return (t = l.sent()) ? (a = t.c,
                            i = t.d,
                            a < 0 || !i || i.accountID < 1 ? (this.props.history.push("/"),
                            this.props.showLogin(),
                            this.props.unloadingPage(),
                            [2]) : [4, p.a.getUltraToken()]) : (this.props.history.push("/"),
                            this.props.showLogin(),
                            this.props.unloadingPage(),
                            [2]);
                        case 2:
                            ...
                            setTimeout(function() {
                                var t = sessionStorage.getItem("ultraLang");
                                t || (t = e),
                                ...
                                $("#header-lang-dropdown li").click(function() {
                                    ...
                                    sessionStorage.setItem("ultraLang", e),
                                ...
                                $("#btn-header-lang .ic-lang").removeClass("en vi zh th km id").addClass(t),
                                $("#header-lang-dropdown li").removeClass("active"),
                                $("#header-lang-dropdown").find("[data-lang='" + t + "']").addClass("active"),
            ...
            t.prototype.render = function() {
                var e = this.state
                  ...
                  , i = e.showPopup
                  , o = e.data
                  , n = window.App.account.portalID
                  , p = 4 === n || 6 === n || 7 === n || 8 === n ? 365 : n
                  , s = this.state.lang
                  , d = sessionStorage.getItem("ultraLang");
                return d || (d = s),
                r.createElement(r.Fragment, null, a && t && r.createElement(r.Fragment, null, r.createElement("header", {
                    ...
                    src: "/assets/images/logo/logo-" + p + ".png",
                    alt: ""
                })), r.createElement("div", {
                    className: "menu-wrap"
                }, r.createElement("div", {
                    ...
                    className: "ic-guide"
                }), r.createElement("span", null, window.Message.GetMessage("sl19", null, d)))), r.createElement("li", {
                    className: "menu-item"
                }, r.createElement("span", {
                    ...
                    className: "ic-zh"
                }), r.createElement("span", null, "\u4e2d\u56fd")), r.createElement("li", {
                    "data-lang": "km"
                }, r.createElement("i", {
                    className: "ic-th"
                }), r.createElement("span", null, "\u0e1b\u0e23\u0e30\u0e40\u0e17\u0e28\u0e44\u0e17\u0e22")), r.createElement("li", {
                    "data-lang": "th"
                }, r.createElement("i", {
                    className: "ic-km"
                }), r.createElement("span", null, "\u0e01\u0e31\u0e21\u0e1e\u0e39\u0e0a\u0e32")), r.createElement("li", {
                    "data-lang": "id"
                }, r.createElement("i", {
                    className: "ic-id"
                }), r.createElement("span", null, "Indonesia"))))), r.createElement("span", {
                    className: "btn-bar",
                    id: "btn-header-bar"
                }, r.createElement("i", null), r.createElement("i", null), r.createElement("i", null))))), i && r.createElement("div", {
                    ...
                    className: "sph-title"
                }, window.Message.GetMessage("sl19", null, d)), r.createElement("span", {
                    className: "sph-cls",
                    ...
                    src: window.Config.ULTRA_URL.replace("{0}", a).replace("{1}", this.getLang(d)),
                    style: {
                        width: "100%",
                        paddingTop: "60px",
