webpackJsonp([19], {
    ...
    930: function(e, t, n) {
        (e.exports = n(583)(!1)).push([e.i, ".sortiee{font-family:Arial,sans-serif;font-size:14px;background:url(" + n(931) + ") no-repeat top;height:1080px;width:1920px;position:absolute;top:50%;left:50%;margin-left:-960px;z-index:1;margin-top:-540px}.sortiee iframe{width:100%!important;height:100%!important;position:relative!important;border:none;display:block!important;-webkit-box-shadow:0 0 10px 6px #26fafe;box-shadow:0 0 10px 6px #26fafe}.sortiee .fish-wrapper{margin:0 auto}.sortiee .fish-wrapper .game-border .game-frame{border-radius:5px;overflow:hidden;height:566px;width:1007px;position:absolute;left:50%;top:50%;margin-top:-283px;margin-left:-503.5px}.sortiee .fish-wrapper .game-border .game-frame p{text-align:center;color:#ff0;font-size:24px;position:absolute;display:block;width:100%;top:50px}.sortiee .fish-wrapper .game-border .game-frame img{width:100%;height:100%;display:block}.sortiee .fish-wrapper .game-border .disabled{opacity:.5;pointer-events:none;-webkit-animation:none;animation:none}.button.button-back,.button.button-mode{width:62px;height:62px;background:url(" + n(932) + ") no-repeat;position:absolute;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;cursor:pointer;z-index:10}.button.button-back:hover,.button.button-mode:hover{background-image:url(" + n(933) + ')}.button.button-back:before,.button.button-mode:before{content:" "}.button.button-mode{top:20px;right:20px}.button.button-mode:before{width:43px;height:43px;background:url(' + n(934) + ") no-repeat}.button.button-mode.window-mode:before{width:35px;height:35px;background:url(" + n(935) + ") no-repeat}.button.button-back{top:20px;left:20px}.button.button-back:before{width:33px;height:32px;background:url(" + n(936) + ") no-repeat}", ""])
    },
    931: function(e, t, n) {
