...
!function(a) {
    ...
    b = function() {
        function c(c, d) {
            ...
            e.visibilityChange = "mozvisibilitychange") : "undefined" != typeof document.msHidden ? (e.hidden = "msHidden",
    ...
    b.prototype.buildRows = function() {
        ...
        a.options.rows > 1) {
            ...
            a.$slider.html(e),
            a.$slider.children().children().children().width(100 / a.options.slidesPerRow + "%").css({
    ...
    b.prototype.checkResponsive = function(b) {
        ...
        c.originalSettings.responsive && c.originalSettings.responsive.length > -1 && null !== c.originalSettings.responsive) {
            ...
            c.refresh())) : (c.activeBreakpoint = e,
            "unslick" === c.breakpointSettings[e] ? c.unslick() : (c.options = a.extend({}, c.originalSettings, c.breakpointSettings[e]),
            b === !0 && (c.currentSlide = c.options.initialSlide),
            c.refresh())) : null !== c.activeBreakpoint && (c.activeBreakpoint = null,
    ...
    b.prototype.getNavigableIndexes = function() {
        ...
        a.options.centerMode === !0 && (e = a.slideCount)) : (b = -1 * a.options.slidesToScroll,
