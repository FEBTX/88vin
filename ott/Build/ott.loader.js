function createUnityInstance(e, t, n) {
    function r(e, t, n) {
        if (u.startupErrorHandler)
            return void u.startupErrorHandler(e, t, n);
        ...
        e.indexOf("UnknownError") != -1 || e.indexOf("Program terminated with exit(0)") != -1 || r.didShowErrorMessage))) {
    ...
    function o(e) {
        return new Promise(function(t, n) {
            ...
            r.addEventListener("load", function(n) {
                i(e, n),
                s(new Uint8Array(r.response), u[e], t)
            }),
            r.send()
        }
        )
        ...
        u.preRun.push(function() {
            ...
            e.then(function(e) {
                ...
                for (n += 4; n < a; ) {
                    ...
                    n += o;
                    for (var l = 0, c = d.indexOf("/", l) + 1; c > 0; l = c,
                    c = d.indexOf("/", l) + 1)
    ...
    u.SystemInfo = function() {
        var e, t, n, r = "-", a = navigator.appVersion, i = navigator.userAgent, s = navigator.appName, o = navigator.appVersion, d = parseInt(navigator.appVersion, 10);
        (t = i.indexOf("Opera")) != -1 ? (s = "Opera",
        o = i.substring(t + 6),
        (t = i.indexOf("Version")) != -1 && (o = i.substring(t + 8))) : (t = i.indexOf("MSIE")) != -1 ? (s = "Microsoft Internet Explorer",
        o = i.substring(t + 5)) : (t = i.indexOf("Edge")) != -1 ? (s = "Edge",
        o = i.substring(t + 5)) : (t = i.indexOf("Chrome")) != -1 ? (s = "Chrome",
        o = i.substring(t + 7)) : (t = i.indexOf("Safari")) != -1 ? (s = "Safari",
        o = i.substring(t + 7),
        (t = i.indexOf("Version")) != -1 && (o = i.substring(t + 8))) : (t = i.indexOf("Firefox")) != -1 ? (s = "Firefox",
        o = i.substring(t + 8)) : i.indexOf("Trident/") != -1 ? (s = "Microsoft Internet Explorer",
        o = i.substring(i.indexOf("rv:") + 3)) : (e = i.lastIndexOf(" ") + 1) < (t = i.lastIndexOf("/")) && (s = i.substring(e, t),
        o = i.substring(t + 1),
        ...
        (n = o.indexOf(")")) != -1 && (o = o.substring(0, n)),
        d = parseInt("" + o, 10),
        isNaN(d) ? (o = "" + parseFloat(navigator.appVersion),
        d = parseInt(navigator.appVersion, 10)) : o = "" + parseFloat(o);
    ...
    u.XMLHttpRequest = function() {
        ...
        function i(t) {
            ...
            this.xhr.addEventListener("load", function() {
                ...
                e("'" + n.result.url + "' successfully revalidated and served from the indexedDB cache")) : 200 == t.status ? (n.result = a(n.result.url, n.company, n.product, n.result.accessed, t),
                n.revalidated = !0,
                l.execute(o.name, "put", [n.result], function(t) {
        ...
        r.prototype.execute = function(e, t, n, r, a) {
            if (this.database)
                ...
                "undefined" == typeof this.database ? this.queue.push(arguments) : "function" == typeof a && a(new Error("indexedDB access denied"))
        }
        ;
        var l = new r;
        i.prototype.send = function(t) {
            var r = this.xhr
              , a = this.cache
              , i = arguments;
            return a.enabled = a.enabled && "arraybuffer" == r.responseType && !t,
            a.enabled ? void l.execute(o.name, "get", [a.result.url], function(t) {
                ...
                "immutable" == a.control)
                    ...
                    e("'" + a.result.url + "' served from the indexedDB cache without revalidation");
                    ...
                    s.onload = function() {
                        ...
                        a.revalidated ? (a.result.revalidated = a.result.accessed,
                        l.execute(o.name, "put", [a.result]),
                        r.dispatchEvent(new Event("load")),
                        e("'" + a.result.url + "' successfully revalidated and served from the indexedDB cache")) : r.send.apply(r, i)
                    }
                    ,
                    s.send()
                } else
                    a.result.responseHeaders["Last-Modified"] ? (r.setRequestHeader("If-Modified-Since", a.result.responseHeaders["Last-Modified"]),
                    r.setRequestHeader("Cache-Control", "no-cache")) : a.result.responseHeaders.ETag && (r.setRequestHeader("If-None-Match", a.result.responseHeaders.ETag),
        ...
        i.prototype.open = function(e, n, r, i, s) {
            return this.cache.result = a(t(n), this.cache.company, this.cache.product, Date.now()),
                ...
                var t = {
                    "inflate.js": function(e, t, n) {
                        ...
                        r.prototype.push = function(e, t) {
                            var n, r, a, i, u, c, f = this.strm, p = this.options.chunkSize, b = this.options.dictionary, m = !1;
                            if (this.ended)
                                return !1;
                            ...
                            do {
                                ...
                                n === l.Z_NEED_DICT && b && (c = "string" == typeof b ? d.string2buf(b) : "[object ArrayBuffer]" === h.call(b) ? new Uint8Array(b) : b,
                                n = s.inflateSetDictionary(this.strm, c)),
                                n === l.Z_BUF_ERROR && m === !0 && (n = l.Z_OK,
                                m = !1),
                                n !== l.Z_STREAM_END && n !== l.Z_OK)
                                    return this.onEnd(n),
                                    this.ended = !0,
                                    !1;
                                f.next_out && (0 !== f.avail_out && n !== l.Z_STREAM_END && (0 !== f.avail_in || r !== l.Z_FINISH && r !== l.Z_SYNC_FLUSH) || ("string" === this.options.to ? (a = d.utf8border(f.output, f.next_out),
                                i = f.next_out - a,
                            ...
                            } while ((f.avail_in > 0 || 0 === f.avail_out) && n !== l.Z_STREAM_END);return n === l.Z_STREAM_END && (r = l.Z_FINISH),
                            r === l.Z_FINISH ? (n = s.inflateEnd(this.strm),
                            this.onEnd(n),
                            this.ended = !0,
                            n === l.Z_OK) : r !== l.Z_SYNC_FLUSH || (this.onEnd(l.Z_OK),
                            f.avail_out = 0,
                            !0)
                        }
                        ,
                    ...
                    "utils/strings.js": function(e, t, n) {
                        ...
                        for (var o = new a.Buf8(256), d = 0; d < 256; d++)
                            o[d] = d >= 252 ? 6 : d >= 248 ? 5 : d >= 240 ? 4 : d >= 224 ? 3 : d >= 192 ? 2 : 1;
                        o[254] = o[254] = 1,
                        n.string2buf = function(e) {
                            var t, n, r, i, s, o = e.length, d = 0;
                            for (i = 0; i < o; i++)
                                n = e.charCodeAt(i),
                                55296 === (64512 & n) && i + 1 < o && (r = e.charCodeAt(i + 1),
                            ...
                            i = 0; s < d; i++)
                                ...
                                56320 === (64512 & r) && (n = 65536 + (n - 55296 << 10) + (r - 56320),
                                i++)),
                                n < 128 ? t[s++] = n : n < 2048 ? (t[s++] = 192 | n >>> 6,
                                t[s++] = 128 | 63 & n) : n < 65536 ? (t[s++] = 224 | n >>> 12,
                                t[s++] = 128 | n >>> 6 & 63,
                                t[s++] = 128 | 63 & n) : (t[s++] = 240 | n >>> 18,
                                t[s++] = 128 | n >>> 12 & 63,
                                t[s++] = 128 | n >>> 6 & 63,
                                t[s++] = 128 | 63 & n);
                            return t
                        ...
                        n.buf2string = function(e, t) {
                            var n, a, i, s, d = t || e.length, l = new Array(2 * d);
                            for (a = 0,
                            n = 0; n < d; )
                                if (i = e[n++],
                                i < 128)
                                ...
                                s > 4)
                                    ...
                                    for (i &= 2 === s ? 31 : 3 === s ? 15 : 7; s > 1 && n < d; )
                                        i = i << 6 | 63 & e[n++],
                                        s--;
                                    s > 1 ? l[a++] = 65533 : i < 65536 ? l[a++] = i : (i -= 65536,
                                    l[a++] = 55296 | i >> 10 & 1023,
                                    l[a++] = 56320 | 1023 & i)
                                }
                            return r(l, a)
                    ...
                    "zlib/inflate.js": function(e, t, n) {
                        ...
                        function o(e, t) {
                            ...
                            t = -t) : (n = (t >> 4) + 1,
                            t < 48 && (t &= 15)),
                            t && (t < 8 || t > 15) ? N : (null !== r.window && r.wbits !== t && (r.window = null),
                            r.wrap = n,
                            r.wbits = t,
                            s(e))) : N
                        }
                        ...
                        function c(e, t, n, r) {
                            ...
                            r >= i.wsize ? (g.arraySet(i.window, t, n - i.wsize, i.wsize, 0),
                            i.wnext = 0,
                            i.whave = i.wsize) : (a = i.wsize - i.wnext,
                            a > r && (a = r),
                            g.arraySet(i.window, t, n - r, a, i.wnext),
                            r -= a,
                            r ? (g.arraySet(i.window, t, n - r, r, 0),
                            i.wnext = r,
                        ...
                        function f(e, t) {
                            var n, a, i, s, o, d, l, f, h, p, b, m, w, be, me, we, ge, ve, ye, ke, xe, _e, Ee, Se, Oe = 0, Ce = new g.Buf8(4), Re = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                            ...
                            e: for (; ; )
                                ...
                                case F:
                                    ...
                                    m > d && (m = d),
                                    m && (n.head && (xe = n.head.extra_len - n.length,
                                ...
                                case j:
                                    if (2048 & n.flags) {
                                        ...
                                        do
                                            xe = a[s + m++],
                                            n.head && xe && n.length < 65536 && (n.head.name += String.fromCharCode(xe));
                                        while (xe && m < d);if (512 & n.flags && (n.check = y(n.check, a, m, s)),
                                        d -= m,
                                        s += m,
                                        xe)
                                            break e
                                ...
                                case P:
                                    if (4096 & n.flags) {
                                        ...
                                        do
                                            xe = a[s + m++],
                                            n.head && xe && n.length < 65536 && (n.head.comment += String.fromCharCode(xe));
                                        while (xe && m < d);if (512 & n.flags && (n.check = y(n.check, a, m, s)),
                                        d -= m,
                                        s += m,
                                        xe)
                                ...
                                case te:
                                    for (; n.have < n.nlen + n.ndist; ) {
                                        for (; Oe = n.lencode[f & (1 << n.lenbits) - 1],
                                        me = Oe >>> 24,
                                        we = Oe >>> 16 & 255,
                                        ge = 65535 & Oe,
                                        !(me <= h); ) {
                                    ...
                                    _e = x(S, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, Ee),
                                    n.distbits = Ee.bits,
                                    _e) {
                                ...
                                case re:
                                    ...
                                    for (n.back = 0; Oe = n.lencode[f & (1 << n.lenbits) - 1],
                                    me = Oe >>> 24,
                                    we = Oe >>> 16 & 255,
                                    ge = 65535 & Oe,
                                    !(me <= h); ) {
                                    ...
                                    if (we && 0 === (240 & we)) {
                                        for (ve = me,
                                        ye = we,
                                        ke = ge; Oe = n.lencode[ke + ((f & (1 << ve + ye) - 1) >> ve)],
                                        me = Oe >>> 24,
                                        we = Oe >>> 16 & 255,
                                        ge = 65535 & Oe,
                                        !(ve + me <= h); ) {
                                ...
                                case ae:
                                    ...
                                    n.mode = ie;
                                case ie:
                                    for (; Oe = n.distcode[f & (1 << n.distbits) - 1],
                                    me = Oe >>> 24,
                                    we = Oe >>> 16 & 255,
                                    ge = 65535 & Oe,
                                    !(me <= h); ) {
                                    ...
                                    if (0 === (240 & we)) {
                                        for (ve = me,
                                        ye = we,
                                        ke = ge; Oe = n.distcode[ke + ((f & (1 << ve + ye) - 1) >> ve)],
                                        me = Oe >>> 24,
                                        we = Oe >>> 16 & 255,
                                        ge = 65535 & Oe,
                                        !(ve + me <= h); ) {
                                ...
                                case le:
                                    if (n.wrap) {
                                        ...
                                        e.total_out += b,
                                        n.total += b,
                                        b && (e.adler = n.check = n.flags ? y(n.check, i, b, o - b) : v(n.check, i, b, o - b)),
                                        b = l,
                            ...
                            n.hold = f,
                            n.bits = h,
                            (n.wsize || b !== e.avail_out && n.mode < fe && (n.mode < le || t !== O)) && c(e, e.output, e.next_out, b - e.avail_out) ? (n.mode = he,
                            I) : (p -= e.avail_in,
                            b -= e.avail_out,
                            e.total_in += p,
                            e.total_out += b,
                            n.total += b,
                            n.wrap && b && (e.adler = n.check = n.flags ? y(n.check, i, b, e.next_out - b) : v(n.check, i, b, e.next_out - b)),
                            e.data_type = n.bits + (n.last ? 64 : 0) + (n.mode === K ? 128 : 0) + (n.mode === ne || n.mode === Q ? 256 : 0),
                        ...
                        function b(e, t) {
                            ...
                            return e && e.state ? (n = e.state,
                            0 !== n.wrap && n.mode !== X ? N : n.mode === X && (r = 1,
                            r = v(r, t, i, 0),
                            r !== n.check) ? A : (a = c(e, t, i, i)) ? (n.mode = he,
                            I) : (n.havedict = 1,
                            L)) : N
                        }
                        var m, w, g = e("../utils/common"), v = e("./adler32"), y = e("./crc32"), k = e("./inffast"), x = e("./inftrees"), _ = 0, E = 1, S = 2, O = 4, C = 5, R = 6, L = 0, W = 1, B = 2, N = -2, A = -3, I = -4, U = -5, T = 8, M = 1, H = 2, D = 3, Z = 4, z = 5, F = 6, j = 7, P = 8, q = 9, G = 10, X = 11, K = 12, V = 13, Y = 14, Q = 15, J = 16, $ = 17, ee = 18, te = 19, ne = 20, re = 21, ae = 22, ie = 23, se = 24, oe = 25, de = 26, le = 27, ue = 28, ce = 29, fe = 30, he = 31, pe = 32, be = 852, me = 592, we = 15, ge = we, ve = !0;
                        n.inflateReset = s,
                        n.inflateReset2 = o,
                    ...
                    "zlib/inftrees.js": function(e, t, n) {
                        ...
                        t.exports = function(e, t, n, p, b, m, w, g) {
                            var v, y, k, x, _, E, S, O, C, R = g.bits, L = 0, W = 0, B = 0, N = 0, A = 0, I = 0, U = 0, T = 0, M = 0, H = 0, D = null, Z = 0, z = new r.Buf16(a + 1), F = new r.Buf16(a + 1), j = null, P = 0;
                            for (L = 0; L <= a; L++)
                                z[L] = 0;
                            for (W = 0; W < p; W++)
                                z[t[n + W]]++;
                            ...
                            return 0 !== H && (b[_ + H] = L - U << 24 | 64 << 16 | 0),
                            g.bits = A,
                            0
                        }
                    }
