var FishConfig={ACCOUNT_URL:"//codegamvip.online/api/Account/getaccountinfo",SERVER_URL:"wss://sortie2.1m88.vin:9094",DOWN_ASSERT_URL:"//codegamvip.online/sortie/bundle/"};if(location.href.indexOf('g88.vin')>=0)
FishConfig={ACCOUNT_URL:"//id.g88.vin/api/Account/GetAccountInfo",SERVER_URL:"wss://sortie2.1m88.vin:9094",DOWN_ASSERT_URL:"//static.g88.vin/sortie/bundle/"};if(location.href.indexOf('1g88.vin')>=0)
FishConfig={ACCOUNT_URL:"//id.1g88.vin/api/Account/GetAccountInfo",SERVER_URL:"wss://sortie2.1m88.vin:9094",DOWN_ASSERT_URL:"//static.1g88.vin/sortie/bundle/"};function GetConfig(){var data=FishConfig.ACCOUNT_URL+";"+FishConfig.SERVER_URL+";"+FishConfig.DOWN_ASSERT_URL+";"+getParameterByName('currency')+";"+getParameterByName('lang');gameInstance.SendMessage("GameManager","OnGetConfig",data);}
